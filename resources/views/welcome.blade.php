...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative min-h-screen bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots-darker dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            @endif
        <div class="flex flex-col items-center justify-center p-10 space-y-4 border-2 border-solid max-auto max-w-7xl lg:pg-8">
            <x-application-logo class="w-24 h-24 fill-current text-primary" />
            <x-button class="rounded-full" primary xl href="{{route('register')}}">Get Started </x-button>
        </div>
